/**
 * AddMemberDialog - Dialog for adding a user to an organization
 *
 * Allows SysAdmin to add an existing user to an organization by email.
 * Validates email and shows appropriate errors.
 *
