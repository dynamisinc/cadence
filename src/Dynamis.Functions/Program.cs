...
using DynamisReferenceApp.Api.Core.Extensions;
using DynamisReferenceApp.Api.Core.Logging;
using DynamisReferenceApp.Api.Core.Middleware;

// =============================================================================
// Dynamis Reference App - Azure Functions Entry Point
// =============================================================================
...
if (autoMigrate)
{
    ...
    var context = scope.ServiceProvider.GetRequiredService<DynamisReferenceApp.Api.Core.Data.AppDbContext>();
