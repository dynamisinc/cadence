...
public interface IObjectiveService
{
    ...
    /// </summary>
    Task<ObjectiveDto> CreateObjectiveAsync(Guid exerciseId, CreateObjectiveRequest request, string createdBy);

    /// <summary>
    /// Update an existing objective.
    /// </summary>
    Task<ObjectiveDto?> UpdateObjectiveAsync(Guid exerciseId, Guid id, UpdateObjectiveRequest request, string modifiedBy);

    /// <summary>
    /// Soft delete an objective.
    /// </summary>
    Task<bool> DeleteObjectiveAsync(Guid exerciseId, Guid id, string deletedBy);
