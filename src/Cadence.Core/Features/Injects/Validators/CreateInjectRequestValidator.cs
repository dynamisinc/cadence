...
/// <summary>
/// FluentValidation validator for <see cref="CreateInjectRequest"/>.
/// Enforces required fields, string length limits, and valid enum values.
/// </summary>
public class CreateInjectRequestValidator : AbstractValidator<CreateInjectRequest>
{
    ...
    /// <summary>
    /// Initializes a new instance of <see cref="CreateInjectRequestValidator"/> with all field rules.
    /// </summary>
    public CreateInjectRequestValidator()
    {
        RuleFor(x => x.Title)
