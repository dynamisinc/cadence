...
namespace Cadence.Core.Migrations
{
    ...
    [Migration("20260128014727_MigrateInjectUserFKsToApplicationUser")]
    partial class MigrateInjectUserFKsToApplicationUser
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Cadence.Core.Models.Entities.ExerciseParticipant", b =>
                {
                    ...
                    b.HasOne("Cadence.Core.Models.Entities.User", null)
                        .WithMany("ExerciseParticipations")
