...
namespace Cadence.Core.Migrations
{
    ...
    [Migration("20260304165019_AddGitHubIntegrationFields")]
    partial class AddGitHubIntegrationFields
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Cadence.Core.Features.Feedback.Models.Entities.FeedbackReport", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Cadence.Core.Models.Entities.OrganizationSuggestion", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("OrganizationId", "FieldName", "Value")
                        .IsUnique();

                    b.HasIndex("OrganizationId", "FieldName", "IsActive", "SortOrder");

                    b.ToTable("OrganizationSuggestions");
                });
